package object_oriented_programming.products;

// Abstract means it can be a base class,
// but you can't instantiate a Product object
...
public abstract class Product {
    ...
    // Abstract methods set a signature that must be followed
    // for a required method definition in child classes
